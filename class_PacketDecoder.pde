class SensorPacketDecoder {
  ...
  int lengths;
  HashMap<String, int> sensor_data = new HashMap<String, int>();
  ...
  void decode_packet( packet_id, byte_data, sensor_data) {
    /* Decodes an OI packet
     ...
     A dict containing the updated sensor states of the Create 2
     */
    HashMap<String, Integer> return_dict = new HashMap<String, Integer>();
    id = int(packet_id)  // Convert the packet id from a string to an int
      ...
      sensor_data.put("battery capacity", this.decode_packet_26(byte_data.pop(), byte_data.pop()));
      sensor_data.put("battery charge", this.decode_packet_25(byte_data.pop(), byte_data.pop()));
      sensor_data.put("temperature", this.decode_packet_24(byte_data.pop()));
      sensor_data.put("current", this.decode_packet_23(byte_data.pop(), byte_data.pop()));
      sensor_data.put("voltage", this.decode_packet_22(byte_data.pop(), byte_data.pop()));
      sensor_data.put("charging state", this.decode_packet_21(byte_data.pop()));
      sensor_data.put("angle", this.decode_packet_20(byte_data.pop(), byte_data.pop()));
      sensor_data.put("distance", this.decode_packet_19(byte_data.pop(), byte_data.pop()));
      sensor_data.put("buttons", this.decode_packet_18(byte_data.pop()));
      sensor_data.put("infared char omni", this.decode_packet_17(byte_data.pop()));
      temp = this.decode_packet_16(byte_data.pop()));
      sensor_data.put("dirt detect", this.decode_packet_15(byte_data.pop()));
      sensor_data.put("wheel overcurrents", this.decode_packet_14(byte_data.pop()));
      sensor_data.put("virtual wall", this.decode_packet_13(byte_data.pop()));
      sensor_data.put("cliff right", this.decode_packet_12(byte_data.pop()));
      sensor_data.put("cliff front right", this.decode_packet_11(byte_data.pop()));
      sensor_data.put("cliff front left", this.decode_packet_10(byte_data.pop()));
      sensor_data.put("cliff left", this.decode_packet_9(byte_data.pop()));
      sensor_data.put("wall seen", this.decode_packet_8(byte_data.pop()));
      sensor_data.put("wheel drop and bumps", this.decode_packet_7(byte_data.pop()));
    } else if ( id == 1) {
      ...
      sensor_data.put("distance", this.decode_packet_19(byte_data.pop(), byte_data.pop()));
      sensor_data.put("buttons", this.decode_packet_18(byte_data.pop()));
      sensor_data.put("infared char left", this.decode_packet_17(byte_data.pop()));
    } else if ( id == 3) {
      ...
      sensor_data.put("charging sources available", this.decode_packet_34(byte_data.pop()));
      temp1 = this.decode_packet_33(byte_data.pop(), byte_data.pop()));
      temp = this.decode_packet_32(byte_data.pop()));
      sensor_data.put("cliff right signal", this.decode_packet_31(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff front right signal", this.decode_packet_30(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff front left signal", this.decode_packet_29(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff left signal", this.decode_packet_28(byte_data.pop(), byte_data.pop()));
      sensor_data.put("wall signal", this.decode_packet_27(byte_data.pop(), byte_data.pop()));
    } else if ( id == 5) {
      // size 12, contains 35-42
      sensor_data.put("requested left velocity", this.decode_packet_42(byte_data.pop(), byte_data.pop()));
      sensor_data.put("requested right velocity", this.decode_packet_41(byte_data.pop(), byte_data.pop()));
      sensor_data.put("requested radius", this.decode_packet_40(byte_data.pop(), byte_data.pop()));
      sensor_data.put("requested velocity", this.decode_packet_39(byte_data.pop(), byte_data.pop()));
      sensor_data.put("number of stream packets", this.decode_packet_38(byte_data.pop()));
      sensor_data.put("song playing", this.decode_packet_37(byte_data.pop()));
      sensor_data.put("song number", this.decode_packet_36(byte_data.pop()));
      sensor_data.put("oi mode", this.decode_packet_35(byte_data.pop()));
    } else if ( id == 6) {
      ...
      sensor_data.put("oi mode", this.decode_packet_35(byte_data.pop()));
      sensor_data.put("charging sources available", this.decode_packet_34(byte_data.pop()));
      temp2 = this.decode_packet_33(byte_data.pop(), byte_data.pop()));
      temp1 = this.decode_packet_32(byte_data.pop()));
      sensor_data.put("cliff right signal", this.decode_packet_31(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff front right signal", this.decode_packet_30(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff front left signal", this.decode_packet_29(byte_data.pop(), byte_data.pop()));
      sensor_data.put("cliff left signal", this.decode_packet_28(byte_data.pop(), byte_data.pop()));
      ...
      temp = this.decode_packet_33(byte_data.pop(), byte_data.pop()));
    } else if ( id == 34) {
      sensor_data.put("charging sources available", this.decode_packet_34(byte_data.pop()));
    } else if ( id == 35) {
      sensor_data.put("oi mode", this.decode_packet_35(byte_data.pop()));
      ...
      sensor_data.put("left encoder counts", this.decode_packet_43(byte_data.pop(), byte_data.pop()));
    } else if ( id == 44) {
      sensor_data.put("right encoder counts", this.decode_packet_44(byte_data.pop(), byte_data.pop()));
    } else if ( id == 45) {
      sensor_data.put("light bumper", this.decode_packet_45(byte_data.pop()));
    } else if ( id == 46) {
      sensor_data.put("light bump left signal", this.decode_packet_46(byte_data.pop(), byte_data.pop()));
    } else if ( id == 47) {
      sensor_data.put("light bump front left signal", this.decode_packet_47(byte_data.pop(), byte_data.pop()));
    } else if ( id == 48) {
      sensor_data.put("light bump center left signal", this.decode_packet_48(byte_data.pop(), byte_data.pop()));
    } else if ( id == 49) {
      sensor_data.put("light bump center right signal", this.decode_packet_49(byte_data.pop(), byte_data.pop()));
    } else if ( id == 50) {
      sensor_data.put("light bump front right signal", this.decode_packet_50(byte_data.pop(), byte_data.pop()));
    } else if ( id == 51) {
      sensor_data.put("light bump right signal", this.decode_packet_51(byte_data.pop(), byte_data.pop()));
    } else if ( id == 52) {
      sensor_data.put("infared char left", this.decode_packet_52(byte_data.pop()));
    } else if ( id == 53) {
      sensor_data.put("infared char right", this.decode_packet_53(byte_data.pop()));
    } else if ( id == 54) {
      sensor_data.put("left motor current", this.decode_packet_54(byte_data.pop(), byte_data.pop()));
    } else if ( id == 55) {
      sensor_data.put("right motor current", this.decode_packet_55(byte_data.pop(), byte_data.pop()));
    } else if ( id == 56) {
      sensor_data.put("main brush motor current", this.decode_packet_56(byte_data.pop(), byte_data.pop()));
    } else if ( id == 57) {
      sensor_data.put("side brush motor current", this.decode_packet_57(byte_data.pop(), byte_data.pop()));
    } else if ( id == 58) {
      sensor_data.put("stasis", this.decode_packet_58(byte_data.pop()));
      // ---- Single Packets END -------------------
    } else if ( id == 100) {
  ...
  void decode_packet_7(byte[] data) {
  ...
  void decode_packet_8(byte[] data) {
     ...
     */
    return this.decode_bool(data);
  }

  void decode_packet_9(byte[] data) {
  ...
  void decode_packet_10(byte[] data) {
  ...
  void decode_packet_11(byte[] data) {
  ...
  void decode_packet_12(byte[] data) {
  ...
  void decode_packet_13(byte[] data) {
  ...
  void decode_packet_14(byte[] data) {
  ...
  void decode_packet_15(byte[] data) {
     ...
     */
    return this.decode_unsigned_byte(data);
  }

  void decode_packet_16(byte[] data) {
  ...
  void decode_packet_17(byte[] data) {
  ...
  void decode_packet_18(byte[] data) {
  ...
  void decode_packet_19( low, high) {
     ...
     */
    return this.decode_short(low, high);
  }
  ...
  void decode_packet_21(byte[] data) {
  ...
  void decode_packet_22( low, high) {
     ...
     */
    return this.decode_unsigned_short(low, high);
  }
  ...
  void decode_packet_24(byte[] data) {
  ...
  void decode_packet_32(byte[] data) {
  ...
  void decode_packet_34(byte[] data) {
  ...
  void decode_packet_35(byte[] data) {
  ...
  void decode_packet_36(byte[] data) {
  ...
  void decode_packet_37(byte[] data) {
  ...
  void decode_packet_38(byte[] data) {
  ...
  void decode_packet_45(byte[] data) {
  ...
  void decode_packet_52(byte[] data) {
  ...
  void decode_packet_53(byte[] data) {
  ...
  void decode_packet_58(byte[] data) {
